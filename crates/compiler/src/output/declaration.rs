//! Adapted from <https://github.com/YarnSpinnerTool/YarnSpinner/blob/3a5b7343f715e4e9a3705fa4224e7fa510b92f1c/YarnSpinner.Compiler/Declaration.cs>
//!
...
pub struct Declaration {
    ...
    /// If `true`, this declaration represents a smart variable (inline
    /// expansion) whose value is computed from an expression at runtime,
    /// rather than being a stored variable with a default value.
    pub is_inline_expansion: bool,

    /// The names of all variables (both direct and transitive) that this
    /// smart variable's expression depends on. Empty for non-smart variables.
    pub dependencies: Vec<String>,

    /// The names of all smart variables whose expressions (directly or
    /// transitively) depend on this variable. Empty if nothing depends on
    /// this variable.
...
impl Declaration {
    ...
    #[doc(hidden)]
    pub fn with_source_node_name_optional(mut self, source_node_name: impl Into<Option<String>>) -> Self {
    ...
    #[doc(hidden)]
    pub fn with_inline_expansion(mut self) -> Self {
        self.is_inline_expansion = true;
        self
    }
    ...
    pub fn eq(&self, other: &Self, epsilon: f32) -> bool {
        self.name == other.name
            ...
            && self.is_inline_expansion == other.is_inline_expansion
...
pub(crate) trait ParserRuleContextExtRangeSource<'input>: ParserRuleContextExt<'input>
where
    <<<<Self as CustomRuleContext<'input>>::TF as TokenFactory<'input>>::Inner as Token>::Data as ToOwned>::Owned: Into<String>,
{
